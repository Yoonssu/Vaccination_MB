...
import com.example.vaccination.databinding.ActivityAuthBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val requestLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
            ...
            try{
                ...
                val crendential = GoogleAuthProvider.getCredential(account.idToken, null) //신용, 한 번 로그인하면 계속 유지
        ...
        binding.googleLoginBtn.setOnClickListener { // 구글인증 Button
            val gso = GoogleSignInOptions
                ...
                .requestEmail()
                .build()
            val signInIntent = GoogleSignIn.getClient(this,gso).signInIntent //구글로그인을 부르는 intent
        ...
        binding.naverLoginBtn.setOnClickListener{
            ...
            NaverIdLoginSDK.initialize(this, getString(R.string.naver_client_id),getString(R.string.naver_client_secret),"vaccinaton")
